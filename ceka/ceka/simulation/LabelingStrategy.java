...
public abstract class LabelingStrategy {
	 ...
	 * @param workers
	 */
	public abstract void assignWorkerQuality(ceka.simulation.MockWorker[] workers);
	 ...
	 */
	public abstract void labelDataset(Dataset dataset, ceka.simulation.MockWorker worker);
