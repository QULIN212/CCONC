...
public class DatumDecorator extends Decorator<Datum> {
	...
	public Double getEvalClassificationCostForDSSoft() {
		return object.getEvalClassificationCost(ClassificationMethod.DS_Soft);
	}

	public Double getEvalClassificationCostForMVSoft() {
		return object.getEvalClassificationCost(ClassificationMethod.MV_Soft);
	}

	public Double getEvalClassificationCostForDSML() {
		return object.getEvalClassificationCost(ClassificationMethod.DS_MaxLikelihood);
	}

	public Double getEvalClassificationCostForMVML() {
		return object.getEvalClassificationCost(ClassificationMethod.MV_MaxLikelihood);
	}
