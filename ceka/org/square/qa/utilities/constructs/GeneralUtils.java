...
//		paramUtils.printNumberedGT(GeneralUtils.nFoldSet.testGT,new File(absPath+"/gt_test.txt"));
		for(int i = 0; i< nFoldSet.workerMaps.size(); i++){
			paramUtils.printNumberedResponses(nFoldSet.workerMaps.get(i),new File(absPath+"/responses_nFold_eval_"+String.format("%03d", i+1) + ".txt"));
			paramUtils.printNumberedResponses(nFoldSet.workerMapsTune.get(i),new File(absPath+"/responses_nFold_tune_"+String.format("%03d", i+1) + ".txt"));
			paramUtils.printNumberedResponses(nFoldSet.workerMapsTrainTune.get(i),new File(absPath+"/responses_nFold_tuneEval_"+String.format("%03d", i+1) + ".txt"));
			paramUtils.printNumberedGT(nFoldSet.gtSet.get(i),new File(absPath+"/gt_nFold_eval_"+String.format("%03d", i+1) + ".txt"));
			paramUtils.printNumberedGT(nFoldSet.gtSetTune.get(i),new File(absPath+"/gt_nFold_tune_"+String.format("%03d", i+1) + ".txt"));
//			paramUtils.printNumberedGT(GeneralUtils.nFoldSet.goldSet.get(i));
		...
		if(!paramDir.isDirectory())
			paramDir.mkdir();
		paramUtils.printMapFileWI(nFoldSet.workerToInt, new File(paramDir.getAbsolutePath()+"/map_worker_integer.txt"));
		paramUtils.printMapFileQI(nFoldSet.questionToInt, new File(paramDir.getAbsolutePath()+"/map_question_integer.txt"));
		paramUtils.printMapFileRI(nFoldSet.categToInt, new File(paramDir.getAbsolutePath()+"/map_category_integer.txt"));}
