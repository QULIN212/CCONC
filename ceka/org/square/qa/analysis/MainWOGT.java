...
final public class MainWOGT {
	...
	private void initializeFromFiles() throws IOException{
		...
		nFoldSet.workersMap = workersMap;
		...
		nFoldSet.responseCategories = responseCategories;
	...
	public void flow() throws IOException{
		...
		if(loadDir==null&&outDir!=null){
			...
			if(!outDir.isDirectory())
				outDir.mkdirs();
			paramUtils.printNumberedResponses(nFoldSet.workersMap,new File(outDir.getAbsolutePath()+"/responses_eval.txt"));
			...
			GeneralUtils.printStatistics(nFoldSet.workersMap,new File(outDir.getAbsolutePath()+"/statistics/train"));}
		...
		GeneralUtils.printStatistics(nFoldSet.workersMap);
		List<Pair<estMethod,Results<String,String> > > resultObjects = null;
		models.setWorkersMap(nFoldSet.workersMap);
		models.setResponseCategories(nFoldSet.responseCategories);
	...
	public List<Pair<estMethod,Results<String,String> > > estimateLabels(Models<String,String,String> models, boolean runTest){
		...
		case Majority:
			...
			log.info("Majority Running Time: " + estimatedTime + " (nanosecond)");
		...
		case Zen:
			...
			log.info("Zen Running Time: " + estimatedTime + " (nanosecond)");
		...
		case Raykar:
			...
			estimatedTime = System.nanoTime() - startTime;
			log.info("Raykar Running Time: " + estimatedTime + " (nanosecond)");
